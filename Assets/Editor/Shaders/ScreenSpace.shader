...
Shader "CYF/ScreenSpace"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "CoreShadersScreenSpacePass"
        CGPROGRAM
            #pragma vertex vert
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                color *= lerp(lerp(BottomLeft, BottomRight, IN.screenPos.x), lerp(TopLeft, TopRight, IN.screenPos.x), IN.screenPos.y);
