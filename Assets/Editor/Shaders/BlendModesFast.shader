...
Shader "CYF/BlendModesFast"
{
    ...
    SubShader
    {
        ...
        GrabPass{"_GrabTextureBLENDMODESFAST"}

        Pass
        {
            Name "CoreShadersBlendModesFastPass"
        CGPROGRAM
            #pragma vertex vert
            ...
            sampler2D _GrabTextureBLENDMODESFAST;
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                half4 dst = (tex2D(_GrabTextureBLENDMODESFAST, IN.grabPos) + _TextureSampleAdd);
