...
Shader "CYF/CopyScreenOnce"
{
    ...
    SubShader
    {
        ...
        GrabPass{"_GrabTextureCOPYSCREENONCE"}

        Pass
        {
            Name "CoreShadersCopyScreenOncePass"
        CGPROGRAM
            #pragma vertex vert
            ...
            sampler2D _GrabTextureCOPYSCREENONCE;
            float4 _GrabTextureCOPYSCREENONCE_ST;
            uniform float4 _GrabTextureCOPYSCREENONCE_TexelSize;
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.uv = TRANSFORM_TEX(v.texcoord, _GrabTextureCOPYSCREENONCE);
                ...
                fixed4 frag(v2f IN) : SV_Target
                {
                    ...
                    IN.uv.x = (floor(IN.uv.x * _GrabTextureCOPYSCREENONCE_TexelSize.z) + 0.5) / _GrabTextureCOPYSCREENONCE_TexelSize.z;
                    IN.uv.y = (floor(IN.uv.y * _GrabTextureCOPYSCREENONCE_TexelSize.w) + 0.5) / _GrabTextureCOPYSCREENONCE_TexelSize.w;
                    #endif
                    ...
                    half4 color = usingVoid ? VoidColor : (tex2D(_GrabTextureCOPYSCREENONCE, IN.uv) + _TextureSampleAdd) * (tex2D(_MainTex, IN.origUV) + _TextureSampleAdd) * IN.color;
